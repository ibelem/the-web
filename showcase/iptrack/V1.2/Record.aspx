    ...
    <div style="text-align:center;">
        ...
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
            ...
            <asp:HyperLinkField DataNavigateUrlFields="IPs" DataNavigateUrlFormatString="http://edu.dheart.net/ip/index.php?ip={0}"
                 ...
                 <asp:HyperLinkField DataNavigateUrlFields="IPs" DataNavigateUrlFormatString="http://zhishi.sogou.com/features/ip.jsp?query={0}"
                    DataTextField="IPs" HeaderText="IP" SortExpression="IPs" Target="_blank" />
      ...
      &copy; 2008 <a href="http://belemview.com" title="BELEM" target="_blank">BELEM</a> <a href="http://belemview.spaces.live.com" title="SPACE" target="_blank">共享空间</a> IPTrack V1.2 版, 添加本地IP地址直接显示功能
      </div>
    </form>
</body>
</html>
