...
public partial class ASCX_CustomizeSelect : System.Web.UI.UserControl
{
    int year, month;
    ...
    private void countNum()
    {
        ...
        tbAllDates.Text = " " +theOutDate.ToString() + " ";
        ...
        else if (rbWed5.Checked)
        {
            theTempInt = 5;
        }
        else if (rbWed6.Checked)
        {
            theTempInt = 6;
        }

        theImgUrl = "CountBase/customize/type1/" + theTempInt.ToString() + ".jpg";

        theImgDisplayStringColor = tbTextColor.Text.Trim();
        theImgDisplayStringColor = theImgDisplayStringColor.Replace("#", "");

        theImgDisplayString = tbFront.Text.Trim() + theOutDate.ToString() + tbTextLast.Text.Trim();
    ...
    string theImgUrl = "";
    string theImgWidth = "178";
    string theImgHeight = "68";
    string theImgPaddingstring = "40px 0px 0px 12px";
    ...
    protected void tbFront_TextChanged(object sender, EventArgs e)
    {
        countNum();
    }
}
