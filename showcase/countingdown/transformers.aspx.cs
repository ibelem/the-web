...
public partial class CountingDown_transformers : System.Web.UI.Page
{
    ...
    private void LiBo()
    {
        DateTime dtTo = DateTime.Parse("2004/4/20");
        ...
        string imgTextShow = "Sean @ Bsoft: " + theOutDate.ToString() + " days.";
        string imgTextShow3 = "New career: " + theOutDate3.ToString() + " days later.";

        string imgFromUrl = "mytrs_r4_c2.jpg";
        ...
        tcColor = ColorTranslator.FromHtml("#0033cc");
        //Color bgcColor = new Color();
        //bgcColor = ColorTranslator.FromHtml("#" + bgc);
        SolidBrush tcbrush = new SolidBrush(tcColor);
        //g.Clear(Color.Transparent);
        g.DrawString(imgTextShow, new Font("tahoma", 12), tcbrush, 8, 10);
        g.DrawString(imgTextShow3, new Font("tahoma", 12), tcbrush, 8, 24);
        g.Dispose();
