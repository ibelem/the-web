...
public partial class CountingDown_h3 : System.Web.UI.Page
{
    ...
    private void LiBo()
    {
        DateTime dtTo = DateTime.Parse("2004/8/29");
        DateTime dtNow = System.DateTime.Now.Date;
        TimeSpan theResult = dtNow - dtTo;

        DateTime dtTo3 = DateTime.Parse("2007/8/29");
        ...
        string imgTextShow = "Sailor @ Bsoft: " + theOutDate.ToString() + " days.";
        string imgTextShow3 = "New career: " + theOutDate3.ToString() + " days later.";

        string imgFromUrl = "h4.jpg";
